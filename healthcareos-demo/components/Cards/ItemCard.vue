<template>
  <NuxtLink
    class="p-4 leading-none rounded-2xl bg-white/60 border border-transparent transition hover:shadow hover:bg-white/100 hover:shadow-slate-900/10 hover:border-slate-200 flex flex-row items-center justify-between opacity-95"
